...
public class ClienteUnitTest {
    ...
    public void testAplicarDescuento() {
        ...
        double descuento = cliente.aplicarDescuentoFidelidad(cliente.calcularMontoTotalCompras(), LocalDate.now()); // Método para aplicar descuento
        assertEquals(10.0, descuento, "El descuento aplicado debería ser del 10%.");
    }
